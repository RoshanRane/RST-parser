"""
Name: rst.py
Author: Valerii Praid

This file containts implementation of RSTTree class used for processing RST trees.
In addition, it provides a create_tree algorithm which builds a tree using keras
neural models for prediction.
"""
